...
Welcome to `gptcommit` contributor's guide.
...
If you experience bugs or general issues with `gptcommit`, please have a look
...
You can help improve `gptcommit` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`gptcommit` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `gptcommit`'s files. While this mechanism can
...
```
conda create -n gptcommit python=3 six virtualenv pytest pytest-cov
conda activate gptcommit
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/gptcommit.git
   cd gptcommit
   ```
...
5. Install [pre-commit]:
   ...
   `gptcommit` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/gptcommit
[issue tracker]: https://github.com/<USERNAME>/gptcommit/issues
